...
DENSITIES = [None]*2  # the set of densities to run experiments with; empty -> var

NUM_GENERATION = 100000
POPULATION_SIZE = 11*2
SCALING_PARAM = 2.38/((11*2)**0.5)  # usually from (0,2] best 0.3
