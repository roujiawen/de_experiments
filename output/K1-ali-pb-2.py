"""
Jan-14-2020
 - Copied from K-ali-pb-1; <- was not enough number of generations, so this experiment will
 evolve more generations
 - Also changed density upperlimit 0.1 -> 0.2
...
SIGNIFICANT_RANGE = [700, 1000]  # range of steps to average over the fitness
