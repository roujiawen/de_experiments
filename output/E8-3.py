...
Oct-07-2020
 - Evolve to Gen=1000
 - Extend E7, try more combinations
 - Fix Gradient Intensity upperbound = 2.0

Subexperiment Code:

     0      1                    2       3
[max_fitness + rand1bin]   [max_fitness + best1bin]
    [1.2, 0.7]                    [1.2, 0.7]

     4      5                    6       7
[max_fitness + rand1bin]   [mean_fitness + best1bin]
    [0.8, 0.9]                    [0.8, 0.9]

P.s. 0 and 1 are the same; 2 and 3 are the same
...
NUM_GENERATION = 1000
POPULATION_SIZE = 100
SCALING_PARAM = 1.2  # usually from (0,2] best 0.3
...
DE_STRATEGY = "best1bin" # choose from {"rand1bin", "best1bin"}


# --------- Feasible model parameter ranges in evolution ---------

PARAM_LIMITS = {
    "Gradient Intensity": [0.0, 2.0],
