"""
Nov-06-2020
 - Based on E8-4/5, adding logs for other order parameters (only avg across sig_range window)
 - 0/1 evolve to Gen=500
 - 2/3 evolve to Gen=1000

Subexperiment Code:

     0 1 2 3
[max_fitness + rand1bin]
    [0.8, 0.9]
