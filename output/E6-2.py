...
Sep-28-2020
 ...
 - Turn gradient back on and use (F, Cr=) [0.8, 0.9] and [1.2, 0.7] (from hyperparam search)
 - Try different gradient upperbound (max=2.0)
...
Cr = 0.9    0.9     0.7     0.7
GU = 2.0    1.0     2.0     1.0
(GU - Gradient Intensity upperbound)
