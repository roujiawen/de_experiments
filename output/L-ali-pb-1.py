...
Dec-31-2020
 - Sanity check
 - Copied from K-ali-pb-1; set all parameters to be fixed to vicsek except for density and noise
 - changed: SIGNIFICANT_RANGE, PARAM_LIMITS
 - inheriting 100 generations and 1000 steps
...
PARAM_LIMITS = {
    ...
    "Cell Density": [0.01, 0.15], # matters only when DENSITIES set to empty
    "Angular Inertia": [0.0, 0.0],
    ...
    "Noise Intensity": [0.0, 1.9],
    "Velocity": [0.03, 0.03],
    "Interaction Range": [10.0, 10.0]
}
